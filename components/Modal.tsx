      ...
      <input
        ...
        />
          {messages.length > 0 ? (
            ...
            <button className="flex items-center justify-center gap-2 w-fit min-w-20 text-lg border border-gray-600 text-gray-600 p-2 rounded-md hover:bg-gray-100" onClick={handleInsert}>
