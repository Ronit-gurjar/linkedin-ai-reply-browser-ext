...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      // Replace this with actual API call or generation logic😂
      ...
      <input
        ...
        />
          {messages.length > 0 ? (
            ...
            <button className="modal-button insert-button" onClick={handleInsert} disabled={isLoading}>
            ...
            <button className="modal-button regenerate-button" onClick={handleRegenerate} disabled={isLoading}>
            ...
            <button className="modal-button" onClick={handleGenerate} disabled={isLoading || !input.trim()}>
