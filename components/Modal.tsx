      ...
      <input
        ...
        />
          {messages.length > 0 ? (
            ...
            {/* <button className="modal-button insert-button" onClick={handleInsert} disabled={isLoading}>  //use when loading response from actual api */}
            <button className="modal-button insert-button" onClick={handleInsert}>
            ...
            {/* <button className="modal-button insert-button" disabled={isLoading}>  //use when loading response from actual api */}
            <button className="modal-button regenerate-button">
          ...
          ) : (<button className="modal-button" onClick={handleGenerate} disabled={!input.trim()}>
          {/* <button className="modal-button" onClick={handleGenerate} disabled={isLoading || !input.trim()}>  //use when loading response from actual api */}
